...
public class MainUser extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, CallbackMainUser, BottomNavigationView.OnNavigationItemSelectedListener
{
    ...
    private void SetReferences()
    {
        ...
        CommitFragments.commitFragment(getSupportFragmentManager(), R.id._contentFragsMUser, FListEvents.class);
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item)
    {
        ...
        if(_fragClass != null)
            CommitFragments.commitFragment(getSupportFragmentManager(), R.id._contentFragsMUser, _fragClass,
    ...
    public void onEventListClicked(Event event)
    {
        ...
        CommitFragments.commitFragmentToBack(getSupportFragmentManager(), R.id._contentFragsMUser, FInfoEvent.class,
